            ...
            <div className="content-wrapper">
              <div className="content-wrapper-header">
                <div className="content-wrapper-context">
                  ...
                  <div className="content-text">Grab yourself 10 free images from Adobe Stock in a 30-day free trial
                    ...
                    <div className="button-wrapper">
                      ...
                      <div className="pop-up">
                        <div className="pop-up__title">Update This App
                          <svg className="close feather feather-x-circle" width="24" height="24" fill="none"
                               stroke="currentColor"
                        ...
                        <div className="pop-up__subtitle">Adjust your selections for advanced options as desired before
